...
import net.sonmok14.fromtheshadows.enchantment.DivinityEnchantment;
import net.sonmok14.fromtheshadows.enchantment.FreezingEnchantment;
import net.sonmok14.fromtheshadows.enchantment.RetributionEnchantment;
