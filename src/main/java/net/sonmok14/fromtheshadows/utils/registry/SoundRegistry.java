...
public class SoundRegistry{
    ...
    public static final RegistryObject<SoundEvent> SHOCK = createSoundEvent("shock");
    ...
    public static final RegistryObject<SoundEvent> WARNING = createSoundEvent("warning");
